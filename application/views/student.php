      ...
      <div id="content">
         ...
         <div class="col-md-12">
          <br/><br/>
         	 <center> 
                     ...
                     <button class="btn btn-warning btn-raised" data-toggle="modal" data-target="#addModal">Add Student</button>
                     <?php } ?>
            </center>
         </div>
       ...
       <div class="row">
                          ...
                          if ($value->user_type =='Student'){ ?> 
                             ...
                             <?php if((isset($user_data[0]->user_type)?$user_data[0]->user_type:'') =='admin') { ?>
												<td><a style="color: red;" href="<?php echo base_url()?>dashboard/delete_student/<?= $value->id?>">Delete</a></td>
											 <?php } ?>
                      </tr>
											<?php } }?>
											</tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center>
          <h4 class="modal-title text-danger" id="formModalLabel">ADD NEW STUDENT</h4>
        </center>
      </div>
      <form class="form-horizontal" role="form" action="<?php echo base_url().'dashboard/add_user_student'?>" method="post">
...
<div class="modal fade" id="bulkModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" action="<?php echo base_url().'dashboard/import_users_student'?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
           <div class="form-group">
             <br><br>
            <div class="col-sm-12">
