          ...
          <br/><br/>
           <center> 
                   ...
                   <br/><br/>
                     ...
                     <button class="btn btn-warning btn-raised" data-toggle="modal" data-target="#addModal">Refresh your Updates</button>
                     <?php } ?>
            </center>
         </div>
            <div class="row">
                  ...
                  <table id="datatable1" class="table table-striped table-hover">
                    <thead>
                      ...
                      <tr>
                        ...
                        <td><a style="color: red;" href="<?php echo base_url()?>user/delete_feedback/<?= $value->id?>">Delete</a></td>
                      </tr>
                      <?php } ?> <
                      </tbody>
                  </table>
                   ...
                   <table id="datatable1" class="table table-striped">
                    <thead>
                      ...
                      <tr>
                        ...
                        <td><?= $value->type; ?></td>
                        <td><?= $value->description; ?></td>
                        <td><?php echo (isset($user_data[0]->register_id)?$user_data[0]->register_id:'');?></td>
                        <?php if($value->reply_by == 'Replying..!') { ?>
                           <form role="form" action="<?php echo base_url().'user/update_reply_feedback'?>" method="post">
                         <td><input  type="text" class="form-control" name="reply" required></td>

                         <td><input  type="hidden" name="reply_by" value="<?php echo (isset($user_data[0]->register_id)?$user_data[0]->register_id:'');?>"  required>
                             <input  type="hidden" name="id" value="<?= $value->id; ?>"  required>
                             <button type="submit" class="btn btn-warning">Reply</button> </td>
                                 </form>   
                        <?php }else { ?>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center>
               ...
               <h4 class="modal-title text-danger" id="formModalLabel">REFRESHMENT UPDATES</h4>   
        </center>
      </div>
      <form class="form-horizontal" role="form" action="<?php echo base_url().'user/add_feedback_student'?>" method="post">
