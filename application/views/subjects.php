    ...
    <div id="base">
      ...
      <div id="content">
        ...
        <section>
          ...
          <br/><br/>
           <center> 
                    <img src="<?php echo base_url() ?>/images/subjects.png">
                   <br/><br/>
                      <?php if((isset($user_data[0]->user_type)?$user_data[0]->user_type:'') =='admin') { ?>
                     <button class="btn btn-warning btn-raised" data-toggle="modal" data-target="#addModal">Add Subject</button>
                     <?php } ?>
            </center>
         </div>
              <div class="col-md-12">
                  ...
                  <table id="datatable1" class="table table-striped table-hover">
                    <thead>
                      ...
                      <tr>
                        ...
                        <?php if((isset($user_data[0]->user_type)?$user_data[0]->user_type:'') =='admin') { ?>
                        <td><a style="color: red;" href="<?php echo base_url()?>user/delete_subject/<?= $value->id?>">Delete</a></td>
                        <?php } ?>
                      </tr>
                      <?php } ?>
                      </tbody>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center>
               ...
               <h4 class="modal-title text-danger" id="formModalLabel">ADD AND ASSIGN FACULTY TO SUBJECT</h4>   
        </center>
      </div>
      <form class="form-horizontal" role="form" action="<?php echo base_url().'user/add_subject'?>" method="post">
        <div class="modal-body">
          ...
          <div class="col-sm-2">
            ...
            <div class="col-sm-4">
              <select id="faculty" name="faculty" class="form-control" required="required">
