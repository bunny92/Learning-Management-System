    ...
    <div id="base">
      ...
      <div id="content">
        ...
        <section>
          ...
          <br/><br/>
           <center> 
                    <img src="<?php echo base_url() ?>/images/material.png">
                   <br/><br/>
                       <?php if((isset($user_data[0]->user_type)?$user_data[0]->user_type:'') =='Professor') { ?>
                     <button class="btn btn-primary btn-raised" data-toggle="modal" data-target="#addModal">Add Material</button>
                     <?php } ?>
            </center>
         </div>
                  ...
                  <table id="datatable1" class="table order-column hover" data-swftools="<?php echo base_url() ?>assets/js/libs/DataTables/extensions/TableTools/swf/copy_csv_xls_pdf.swf">
                    <thead>
                      ...
                      <tr>
                        ...
                        <td><?= $value->subject; ?></td>
                        <td><?= $value->type; ?></td>
                                          <td><a style="color: green;" href="<?php echo base_url();?>images/<?php echo $value->notes ?>">view</a></td>
                                            <?php if($user_data[0]->user_type =='Professor') { ?>
                        <td><a style="color: red;" href="<?php echo base_url()?>dashboard/delete_notes/<?= $value->id?>">Delete</a></td>
                        <?php } ?>
                      </tr>
                      <?php } ?>
                      </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center>
          <h4 class="modal-title text-danger" id="formModalLabel">ADD MATERIAL TO REFER</h4>
        </center>
      </div>
      <form  enctype="multipart/form-data"  class="form-horizontal" role="form" action="<?php echo base_url().'dashboard/upload_file'?>" method="post">
          <div class="form-group">

  <input type="hidden" name="user_id" value="<?php echo (isset($user_data[0]->id)?$user_data[0]->id:'');?>">
            <div class="col-sm-3">
          ...
          <div class="form-group">
            <div class="col-sm-3">
              <label for="select13" class="control-label">Notes</label>
            </div>
            <div class="col-sm-9">
