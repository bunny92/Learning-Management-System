          ...
          <br/><br/>
           <center> 
                   ...
                   <br/><br/>
                     ...
                     <button class="btn btn-warning btn-raised" data-toggle="modal" data-target="#addModal">Update Results</button>
                     <?php } ?>
            </center>
         </div>
            <div class="row">
                ...
                <div class="table-responsive">
                  ...
                  <table id="datatable1" class="table table-striped table-hover">
                    <thead>
                      ...
                      <tr>
                        <td><?= ++$index?></td>
                        <td><a class="text-warning" href="<?php $value->link; ?>">Link</a></td>
                        ...
                        <?php if((isset($user_data[0]->user_type)?$user_data[0]->user_type:'') =='admin') { ?>
                        <td><a style="color: red;" href="<?php echo base_url()?>user/delete_result/<?= $value->id?>">Delete</a></td>
                        <?php } ?>
                      </tr>
                      <?php } ?>
                      </tbody>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center>
               ...
               <h4 class="modal-title text-danger" id="formModalLabel">UPDATED RESULTS LINK</h4>   
        </center>
      </div>
      <form class="form-horizontal" role="form" action="<?php echo base_url().'user/add_results'?>" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
               <input type="text" name="link" class="form-control" id="link" required="required">
            </div>
          </div>
            <div class="form-group">
            <div class="col-sm-2">
            ...
            <div class="col-sm-6">
               <input type="text" name="description" class="form-control" id="type" required="required">
            </div>
          </div>
         ...
         <center><button type="submit" class="btn btn-warning">Update Results</button>
          </center>
        </div>
