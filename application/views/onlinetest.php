    ...
    <div id="base">
      ...
      <div id="content">
        ...
        <section>
          ...
          <br/><br/>
           <center> 
                    <img src="<?php echo base_url() ?>/images/feedback.png">
                   <br/><br/>
                      <?php if((isset($user_data[0]->user_type)?$user_data[0]->user_type:'') =='Professor') { ?>
                     <button class="btn btn-warning btn-raised" data-toggle="modal" data-target="#addModal">Upload Test File</button>
                     <span class="text-danger">Only Pdf formated files...!</span>
                     <?php } ?>
            </center>
         </div>
            <div class="row">
                  ...
                  <table id="datatable1" class="table table-striped">
                    <thead>
                      ...
                      <tr>
                        ...
                        <td><a class="text-warning" href="<?php echo base_url();?>user/view_paper/<?= $value->id?>">view</a></td>
                      
                         </tr>
                         <?php } ?>
                      </tbody>
                  </table>
                  <?php }elseif((isset($user_data[0]->user_type)?$user_data[0]->user_type:'') =='Professor') { ?>
                   <table id="datatable1" class="table table-striped">
                    <thead>
                                                <th>ID</th>
                                                <th>Year</th>
                      ...
                      <tr>
                        ...
                        <td><?= $value->faculty; ?></td>
                         <td><?= $value->updated_date; ?></td>
                        <td><a class="text-warning" href="<?php echo base_url();?>images/<?php echo $value->test ?>">view</a></td>
                        <?php if((isset($user_data[0]->user_type)?$user_data[0]->user_type:'') =='Professor') { ?>
                        <td><a style="color: red;" href="<?php echo base_url()?>user/delete_test/<?= $value->id?>">Delete</a></td>
                       <?php  } ?>
                         </tr>
                         <?php }  ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center>
          <h4 class="modal-title text-danger" id="formModalLabel">ADD TEST QUESTION PAPER</h4>
        </center>
      </div>
      <form  enctype="multipart/form-data"  class="form-horizontal" role="form" action="<?php echo base_url().'user/upload_test'?>" method="post">
          <div class="form-group">

  <input type="hidden" name="faculty" value="<?php echo (isset($user_data[0]->name)?$user_data[0]->name:'');?>">
            <div class="col-sm-3">
          ...
          <div class="form-group">
            <div class="col-sm-3">
              <label for="select13" class="control-label">Questions</label>
            </div>
            <div class="col-sm-9">
              <div class="input-group">
                <label class="input-group-btn">
                    <span class="btn btn-danger">
                        Browse&hellip; <input type="file" name="test" style="display: none;" required>
                    </span>
                </label>
